...
const shippingCost = ref(shippingCosts.value.find((shippingCost) => {
  return shippingCost.shippingMethod.id === selectedShippingMethod.value.id
}));
    ...
    <slot name="shipping">
      <div class="mb-4">
        ...
        <template v-if="showSelectionSelect">
          <UiSelect
              :modelValue="selectedShippingMethod.id"
              @update:modelValue="setSelectedShippingMethod"
          >
            <UiSelectTrigger>
              <UiSelectValue/>
            </UiSelectTrigger>
  ...
  <slot name="promotion">
    <div class="mb-4">
      ...
      <div class="flex w-full max-w-sm">
        <UiInput class="w-full" type="text" v-model="inputPromotionCode"
