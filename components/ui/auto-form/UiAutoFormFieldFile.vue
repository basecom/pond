        ...
        <UiFormItem v-bind="$attrs">
            ...
            <UiFormControl>
                <slot v-bind="slotProps">
                    ...
                    />
                    <div v-else class="flex h-9 w-full items-center justify-between rounded-md border border-gray-200 bg-transparent py-1 pl-3 pr-1 text-sm shadow-sm transition-colors">
                        <p>{{ inputFile?.name }}</p>
                        <UiButton
                            :size="'icon'"
                            :variant="'ghost'"
