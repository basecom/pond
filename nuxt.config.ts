...
export default defineNuxtConfig({
    ...
    i18n: {
        ...
        locales: [
            {
                code: 'de-DE',
                files: ['de-DE/account.json', 'de-DE/error.json', 'de-DE/general.json', 'de-DE/cms.json'],
            },
            {
                code: 'en-GB',
                files: ['en-GB/account.json', 'en-GB/error.json', 'en-GB/general.json', 'en-GB/cms.json'],
            },
        ],
        lazy: true,
        bundle: {
