...
export default defineNuxtConfig({
    ...
    i18n: {
        ...
        locales: [
            {
                code: 'de-DE',
                files: ['de-DE/account.json', 'de-DE/error.json', 'de-DE/general.json', 'de-DE/checkout.json'],
            },
            {
                code: 'en-GB',
                files: ['en-GB/account.json', 'en-GB/error.json', 'en-GB/general.json', 'en-GB/checkout.json'],
            },
        ],
        lazy: true,
        bundle: {
